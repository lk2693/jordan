        ...
        <div className={`absolute top-0 right-0 h-full w-[85%] max-w-sm bg-white shadow-2xl transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="flex flex-col h-full pt-24 pb-8 px-6">
            ...
            <div className="space-y-3 pt-6 border-t border-slate-100">
              <a href="tel:053123449090" className="flex items-center justify-center gap-2 w-full bg-red-50 text-red-700 font-semibold py-3.5 rounded-xl hover:bg-red-100 transition-colors" onClick={() => setIsMenuOpen(false)}>
